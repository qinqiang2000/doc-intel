  ...
  return (
    <div className="fixed left-0 right-0 bottom-0 h-[480px] bg-[#1a1d27] border-t border-[#2a2e3d] z-50 flex flex-col text-sm">
      ...
      <div className="flex-1 overflow-auto p-4 space-y-4">
        {stream.error && (
          <div className="text-sm text-[#ef4444] bg-[#3f1d1d] border border-danger rounded p-2">
            {stream.error}
          </div>
        )}
        {(stream.active || stream.promptTokens.length > 0) && !stream.revisedPrompt && (
          <div>
            <div className="text-xs text-[#94a3b8] mb-1">{t("workspacePage.revisingPrompt")}</div>
        ...
        {promptDiff && (
          <div>
            <div className="text-xs text-[#94a3b8] mb-1">{t("workspacePage.revisedPrompt")}</div>
        ...
        {resultDiff && (
          <div>
            <div className="text-xs text-[#94a3b8] mb-1">{t("workspacePage.predictResult")}</div>
